        ...
        if (fromMessageType.equals("text"))
        {
            ...
            if(fromUserID.equals(messageSenderId))
            {
               ...
               // messageViewHolder.messageSenderPicture.setBackgroundResource(R.drawable.file);
                ...
                Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/whatsapp-5199d.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=eb73035d-b15a-4c3f-80ce-1c8de413aa57")
